...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($nombre_proveedor && empty($errores)) {
        try {
            $sql = "INSERT INTO proveedores (nombre_proveedor, tipo_proveedor, direccion, telefono, correo) VALUES (?, ?, ?, ?, ?)";
            ...
            echo "<script>alert('Proveedor registrado exitosamente'); window.location.href='R_proveedores.php';</script>";
        ...
        if (!empty($errores)) {
            ...
            echo "<div style='color: red; margin: 10px 0;'>Por favor ingrese el nombre del proveedor.</div>";
        }
    }
}
?>
    ...
    <div class="container">
        ...
        <form method="POST" id="proveedorForm">
            <div class="form-group">
                ...
                <input type="text" name="nombre_proveedor" id="nombre_proveedor" required maxlength="100" 
            ...
            <div class="form-group">
                ...
                <select name="tipo_proveedor" id="tipo_proveedor">
                    ...
                    <?php foreach ($tipos_permitidos as $tipo): ?>
                        <option value="<?= $tipo ?>" <?= (($_POST['tipo_proveedor'] ?? '') == $tipo) ? 'selected' : '' ?>>
                            <?= $tipo ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" name="direccion" id="direccion" maxlength="150"
